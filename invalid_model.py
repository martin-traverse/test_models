...
classHelloPyspark(trac.TracModel):
    ...
    def defineinputs(self) -> tp.Dict[str, trac.ModelInputSchema]:
...
if __name__ == "__main__":
    ...
    launch.launchmodel(HelloPyspark, "hello_pyspark.yaml", "examples/sys_config.yaml")
